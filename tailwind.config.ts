    ...
    extend: {
      colors: {
        ...
        transport: {
          ...
          airport: "hsl(var(--transport-airport))",
          railway: "hsl(var(--transport-railway))",
          taxi: "hsl(var(--transport-taxi))",
      ...
      fontSize: {
        ...
        "heading-1": ["2.25rem", { lineHeight: "1.3", fontWeight: "700" }],
        "heading-2": ["1.875rem", { lineHeight: "1.35", fontWeight: "600" }],
      ...
      boxShadow: {
        "glow-primary": "0 0 30px -5px hsl(var(--primary) / 0.3)",
        "glow-accent": "0 0 30px -5px hsl(var(--accent) / 0.3)",
        "glow-destructive": "0 0 30px -5px hsl(var(--destructive) / 0.3)",
